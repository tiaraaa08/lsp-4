<div class="modal" id="editTransaksi{{ $t->id }}" tabindex="-1" aria-hidden="true">
            ...
            <form action="{{ route('transaksi.update', $t->id) }}" method="POST">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-4">
                            <div class="form-floating form-floating-outline">
                                <div class="input-group">
                                    <input required type="number" value="{{ $t->berat }}" name="berat"
                                        class="form-control berat" placeholder="Berat">
                    ...
                    <div class="row mt-3">
                        <div class="col ">
                            <div class="form-floating form-floating-outline">
                                <input required type="text" id="nameBasic" readonly class="form-control totalHarga"
                        ...
                        <div class="col ">
                            <div class="form-floating form-floating-outline">
                                <input required type="text" value="{{ $t->jumlah_bayar }}" name="jumlah_bayar" id="nameBasic"
                                    class="form-control jumlahBayar" placeholder="Harga Per KG" />
                    ...
                    <div class="row mt-3">
                        <div class="col ">
                            <div class="form-floating form-floating-outline">
                                <select required name="keterangan" class="form-select layanan"
                                    aria-label="Default select example">
                                    <option {{ $t->keterangan == 'Proses' ? 'selected' : '' }} value="Proses">Proses
                                    </option>
                                    <option {{ $t->keterangan == 'Selesai' ? 'selected' : '' }} value="Selesai">Selesai
                                    </option>
                                </select>
                        ...
                        <div class="col ">
                            <div class="form-floating form-floating-outline">
                                <select required name="pembayaran" class="form-select layanan"
                                    aria-label="Default select example">
                                    <option {{ $t->pembayaran == 'Belum Bayar' ? 'selected' : '' }}
                                        value="Belum Bayar">Belum Bayar</option>
                                    <option {{ $t->pembayaran == 'Lunas' ? 'selected' : '' }} value="Lunas">Lunas
                                    </option>
                                </select>
